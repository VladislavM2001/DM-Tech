...
namespace DM_Tech
{
    public partial class Calculator : Form
    {
        ...
        {
            string searchvalue = "D9000A A1R(490μA):" + Form2.TextP;
            textBox3.Text = "0";
            f = new Form2();
            f.ShowDialog();
            ...
            {
                if (listBox1.Items.Contains(searchvalue))
                {
                    listBox1.Items.Remove(searchvalue);
                    listBox1.Items.Add("D9000A A1R(490μA):" + Form2.TextP);
                }
                else { listBox1.Items.Add("D9000A A1R(490μA):" + Form2.TextP); }
        ...
        {
            string searchvalue = "D9000AI A1R(510μA):" + Form2.TextP;
            textBox4.Text = "0";
            f = new Form2();
            f.ShowDialog();
            textBox4.Clear();
        ...
        {
            string searchvalue = "D9000A A1S(490μA):" + Form2.TextP;
            textBox5.Text = "0";
            f = new Form2();
            f.ShowDialog();
            listBox1.Items.Add("D9000A A1S(490μA):" + Form2.TextP);
        ...
        {
            string searchvalue = "D9000AI A1S(510μA):" + Form2.TextP;
            textBox6.Text = "0";
            f = new Form2();
            f.ShowDialog();
        ...
        {
            string searchvalue = "D9000A SR(500μA):" + Form2.TextP;
            if (listBox1.Items.Contains(searchvalue))
            {
                listBox1.Items.Remove(searchvalue);
            }
        ...
        {
            string searchvalue = "D9000AI SR(520μA):" + Form2.TextP;
            textBox8.Text = "0";
            f = new Form2();
            f.ShowDialog();
        ...
        {
            string searchvalue = "D9000A MSR(510μA):" + Form2.TextP;
            textBox9.Text = "0";
            f = new Form2();
            f.ShowDialog();
        ...
        {
            string searchvalue = "D9000A MCP(450μA):" + Form2.TextP;
            textBox11.Text = "0";
            f = new Form2();
            f.ShowDialog();
        ...
        {
            string searchvalue = "M9000A ACZ(30mA):" + Form2.TextP;
            textBox12.Text = "0";
            f = new Form2();
            f.ShowDialog();
        ...
        {
            string searchvalue = "M9000A IN/OUT(500μA):" + Form2.TextP;
            textBox13.Text = "0";
            f = new Form2();
            f.ShowDialog();
        ...
        {
            string searchvalue = "S9000A(10mA):" + Form2.TextP;
            textBox14.Text = "0";
            f = new Form2();
            f.ShowDialog();
